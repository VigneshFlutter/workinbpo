...
class shortlisted2 extends StatefulWidget {
  const shortlisted2({Key? key}) : super(key: key);

  @override
  State<shortlisted2> createState() => _shortlisted2State();
}

class _shortlisted2State extends State<shortlisted2> {
  @override
