...
const String APP_BASE_URL = 'https://knownjobz.com/api/';
const String DASHBOARD_URL = '${APP_BASE_URL}company' ;
const String PROFILE_URL = '${APP_BASE_URL}company-profile' ;
const String IMAGEBASEURL = 'https://knownjobz.com/company_logos/';
const String MASTER_URL = '${APP_BASE_URL}masters';
